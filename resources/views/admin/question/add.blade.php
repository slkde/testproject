						...
						<tr>
							...
							<td>							 
							  <!--  <input type="text" size="50" class="lg" name="photo" id="art_thumb"> -->
								<input id="file_upload" name="photo1" type="file" multiple="true" value="{{old('photo')}}">
								<p><img id="img1" alt="上传后显示图片"  style="max-width:350px;max-height:100px;" />
									<input type="hidden" name="photo" id="img2">
								</p>
