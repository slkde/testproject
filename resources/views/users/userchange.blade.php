  ...
  <div class="container">
    ...
    <div class="bloglist f_l"><br><br><br><br>
      <form action="{{ url('/user/changes') }}" method="post" style="padding-left:200px">
        {{ csrf_field() }}
        昵&nbsp&nbsp称：<input type="text" name="nickname" placeholder="{{ $user['nickname'] }}"><br><br><br>
        ...
        手&nbsp&nbsp机：<input type="text" name="phone" placeholder="{{ $user['phone'] }}"><br><br><br>
        邮&nbsp&nbsp箱：<input type="email" name="email" placeholder="{{ $user['email'] }}"><br><br><br>
        职&nbsp&nbsp业：<input type="text" name="job" placeholder="{{ $user['job'] }}"><br><br><br>
